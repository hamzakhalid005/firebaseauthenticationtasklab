...
public class insertdata extends AppCompatActivity {
    ...
    private Button imageUploadingBtn, backbtn;
    ...
    private void connectXMLToJava() {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(insertdata.this, logout.class));
                finish();
            ...
            if (imageDataInUriForm != null && !imageNameET.getText().toString().isEmpty()
                ...
                uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            objectFirebaseFirestore.collection("Gallery")
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            Toast.makeText(insertdata.this, "Fails To Upload Image URL: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    })
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Toast.makeText(insertdata.this, "Image Successfully Uploaded: ", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(insertdata.this, "Fails To Upload Image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
